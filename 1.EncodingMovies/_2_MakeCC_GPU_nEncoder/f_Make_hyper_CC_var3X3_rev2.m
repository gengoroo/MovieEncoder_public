...
function fn_full_CC_hyper_stack = f_Make_hyper_CC_var3X3_rev2(pn_CC,varargin)
    ...
    for id_dataset = 1:numel(pn_im_stack)
        ...
        if ~exist(fn_CC_allcut_full,'file')
            ...
            save(strcat(pn_im_stack{id_dataset},'\CC_hyper.mat'),'CC_rev_hyper','CC_hyper','CC_var_rev_hyper','CC_var_hyper','CC_var_rev_hyper_min','CC_var_hyper_min','CC_var_rev_hyper_max','CC_var_hyper_max');
        end
    end
    pn_parent_cc = fileparts(pn_im_stack{1});
    save(strcat(pn_parent_cc,'\CC_hyper_stack.mat'),'CC_rev_hyper_stack','CC_hyper_stack','pn_im_stack','CC_var_rev_hyper_stack','CC_var_hyper_stack','CC_var_rev_hyper_min_stack','CC_var_hyper_min_stack','CC_var_rev_hyper_max_stack','CC_var_hyper_max_stack','CC_stack','CC_var_stack');
